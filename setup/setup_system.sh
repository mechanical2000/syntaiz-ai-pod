...
wget --header="Authorization: Bearer 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" "https://huggingface.co/TheBloke/auto-gptq/resolve/main/auto_gptq-0.4.2-cp310-cp310-linux_x86_64.whl" -O /tmp/auto_gptq.whl
